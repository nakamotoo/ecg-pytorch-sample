# 2d cnnモデルに，年齢・性別のメタデータを追加

import torch.nn as nn
import torch.nn.functional as F
import torch

class Model_2D_Meta(nn.Module):
    def __init__(self, input_length = 5000):
        super(Model_2D_Meta, self).__init__()
        ...
        self.fc1 = nn.Linear(64 * 1 * self.output_length + 2, 256) # 5000の場合 : (64, 1, 8), 4000の場合 : (64, 1, 7)
